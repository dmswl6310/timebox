...
- 일기와 기분 자동 저장
- 오늘·주·달력 월·연간·전체 통계, 월별 이동, 태그별 계획·실제 시간 비교와 원래 날짜를 바로 여는 기록 검색
...
- 계획 확정 후의 중간 편집은 기록하지 않습니다. `일과 완료`를 누르면 확정본과 최종본을 비교해 추가·이동·크기 변경·삭제만 `schedule_change_events`에 기록하고 그날을 잠급니다.
